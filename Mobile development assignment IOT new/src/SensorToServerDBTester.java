...
/**
 * This class is the database tester hwich would add the data to the database
 * @author Dhanyaal
 *
 */
public class SensorToServerDBTester  {
    ...
    public static String sensorServerURL = "http://localhost:8080/IOTServernew/SensorServerDB";
	...
	// Creating public sensor to server db tester method, to send the data in json format
	...
	} // Close SensorToServerdbTester method
...
} // Close public class sensor to serverdb tester