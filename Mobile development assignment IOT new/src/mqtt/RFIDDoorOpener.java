 ...
 *  Setting the user id
 *  The check tag method would check if valid tag has been used to open the door.
...
public class RFIDDoorOpener  {
	...
	public static String sensorServerURL = "http://localhost:8080/IOTServernew/controler-00";
