...
/**
 * This class is the Motor subsriber class which calls the motor subscriber callback class.
 ...
 * The publisher and subscriber would refer to whether the client has published the messages or subsribed to messages.
 * 
 * @author dhanyaal.
 */
...
public class MotorSubscriber {
	 ...
	 *  Once the messages have been pubished to the correct topic, it will then subscribe to the correct.
	 *  The mqtt client would be connected to the client.
	 *  It will then subscribe to the correct topic and publish the data. 
	 *  It will then start subscribing the messages and move the motor
	 */
	public void start() {
		try {
