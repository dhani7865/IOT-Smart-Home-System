...
// Creating the PhidgetPublisherMotorSolution
public class PhidgetPublisherMotorSolution {
	...
	// Creating public string for the topic rfid and motor
	...
	// Creating public PhidgetPublisherMotorSolution method
	...
	} // Close PhidgetPublisherMotorSolution method
	...
	// Creating public void publishSensor to publish the sensor to the correct topic
	public void publishSensor(String sensorValue, String sensorName) throws MqttException {
		// Publish the messages to the topic_generic
	...
	} // close publishSensor method
	
	// Creating public void publishSensor to publish the sensor value and sensor name
	...
	} // publishSensor method
	
	// Creating publish sensor and setting float parameter for the sensor value and string for the sensor name which throws mqtt exception
	public void publishSensor(float sensorValue, String sensorName) throws MqttException {
		// Converting float to String
		publishSensor(String.valueOf(sensorValue), sensorName);
	} // Close publish sensor method
} // CLose PhidgetPublisherMotorSolution class
