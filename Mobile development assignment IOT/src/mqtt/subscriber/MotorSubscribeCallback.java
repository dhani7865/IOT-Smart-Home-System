...
public class MotorSubscribeCallback implements MqttCallback {
	...
	public void messageArrived(String topic, MqttMessage message) throws MqttException {
		...
		SensorData data = new SensorData("1600ee15e9","OPEN DOOR","16038287");
		Gson gson = new Gson();
		...
		SensorData data2 = new SensorData("motor","LOCKED","none");
		...
		//		// passing tag data from json and calling the toString method and tag data class
		//        TagData td = gson.fromJson(message.toString(), TagData.class);
		//        System.out.println("DEBUG: Subscriber Callback received message " + td.toString());
		//		System.out.println("DEBUG: Storing state of lock");
