...
/**
 *  Creating rfid door opener class.
 *  Setting the user id
 *  If valid tag has been used open the door.
 *  Otherwise, invalid tag door  not open.
 *  The data will then be sent to the database. 
 */

// Creating public class for the rfid door opener
public class RFIDDoorOpener  {
	// Creating a list of valid tags which are recognised
	final String[] tagArray = { "1600ee15e9", "tag1", "tagi23","4d004a7bbf23", "0106936200", "0106936200"};
	...
	public static String sensorServerURL = "http://localhost:8080/IOTServer/RFIDDao";
	...
	public RFIDDoorOpener() throws PhidgetException {
		...
		try {
				...
				public void onTag(RFIDTagEvent e) {
					...
					try {
						...
						if (tagArray1.contains(tagStr)) {
							...
							RFID.setSensorvalue("Room3, Door open");// Setting the valid sensor value
			...
			// This will then print out tag lost nto the console, when the tag has been lost.
